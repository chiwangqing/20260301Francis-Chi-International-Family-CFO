...
export const translations = {
  TC: {
    ...
    why: {
      ...
      pain: {
        title: '碎片化產品銷售 (痛點)',
        desc: '銀行家看產品，律師看條款，會計師看稅單。碎片化的建議往往導致資產架構相互衝突。在稅務稽查或家族變故面前，缺乏頂層設計的資產如同散落的拼圖，脆弱不堪。',
      },
      solution: {
        title: 'Francis 的財富結構工程：從良率到勝率',
        points: [
          {
            label: '從「碎片化」到「系統性一致」',
            desc: '引入 Intel 的「良率管理」思維。將銀行、保險、信託無縫集成，確保每一個金融動作都絕對服從於家族的終極藍圖。',
          },
          {
            label: '從「被動防禦」到「主動隔離」',
            desc: '預演未來 30 年「人、財、事」的變遷，提前編寫風險防火牆，讓您在不確定性中掌握絕對的主動權。',
          },
          {
            label: '從「利益博弈」到「買方守門人」',
            desc: '我與單一產品解綁，只與您的家族利益綁定。在全球市場中為您篩選最優資產，做您最忠誠的「首席採購官」。',
          },
        ],
      },
    },
    ...
    brandStory: {
      ...
      quote: '「在財富的世界裡，0.1% 的底層代碼誤差，經過時間的複利，就是一代人的遺憾。」',
      content: [
    ...
    coreValues: {
      ...
      transformations: [
        {
          title: '從「碎片化」到「系統化」',
          pain: '私人銀行家看產品，律師看法律，會計師看稅務。不同機構間的信息孤島，導致您的資產像散落的拼圖，缺乏統一的頂層設計，甚至因架構衝突導致風險外溢。',
          solution: '「我是您資產的系統架構師。」 我將 Intel 晶圓製造的良率管理思維引入財富管理。作為您的全職 CFO，我負責協調銀行、保險、信託與法務團隊，運用 4+1 資產全景模型，確保每一個金融動作都服務於同一個終極目標。',
        },
        {
          title: '從「被動應對」到「主動佈局」',
      ...
      factor: {
        ...
        items: [
          ...
          },
          {
            ...
            desc: '從大陸的成長背景，到日本早稻田的科研歷練，再到香港恆生大學的金融深造。我深諳東亞家族的文化羈絆與西方金融的契約精神，守護家族財富永續。',
          },
        ],
      },
    },
  ...
  SC: {
    ...
    why: {
      ...
      pain: {
        title: '碎片化产品销售 (痛点)',
        desc: '银行家看产品，律师看条款，会计师看税单。碎片化的建议往往导致资产架构相互冲突。在税务稽查或家族变故面前，缺乏顶层设计的资产如同散落的拼图，脆弱不堪。',
      },
      solution: {
        title: 'Francis 的财富结构工程：从良率到胜率',
        points: [
          {
            label: '从「碎片化」到「系统性一致」',
            desc: '引入 Intel 的「良率管理」思维。将银行、保险、信托无缝集成，确保每一个金融动作都绝对服从于家族的终极蓝图。',
          },
          {
            label: '从「被动防御」到「主动隔离」',
            desc: '预演未来 30 年「人、财、事」的变迁，提前编写风险防火墙，让您在不确定性中掌握绝对的主动权。',
          },
          {
            label: '从「利益博弈」到「买方守门人」',
            desc: '我与单一产品解绑，只与您的家族利益绑定。在全球市场中为您筛选最优资产，做您最忠诚的「首席采购官」。',
          },
        ],
      },
    },
    ...
    brandStory: {
      ...
      quote: '「在财富的世界里，0.1% 的底层代码误差，经过时间的复利，就是一代人的遗憾。」',
      content: [
    ...
    coreValues: {
      ...
      transformations: [
        {
          title: '从「碎片化」到「系统化」',
          pain: '私人银行家看产品，律师看法律，会计师看税务。不同机构间的信息孤岛，导致您的资产像散落的拼图，缺乏统一的顶层设计，甚至因架构冲突导致风险外溢。',
          solution: '「我是您资产的系统架构师。」 我将 Intel 晶圆制造的良率管理思维引入财富管理。作为您的全职 CFO，我负责协调银行、保险、信托与法务团队，运用 4+1 资产全景模型，确保每一个金融动作都服务于同一个终极目标。',
        },
        {
          title: '从「被动应对」到「主动布局」',
